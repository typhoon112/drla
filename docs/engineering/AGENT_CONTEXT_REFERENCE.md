...
P0/P1 历史执行顺序见 `docs/historical_design/DRLA_Implementation_Plan.md`；当前 P2 执行顺序以 `docs/current/P2_Latent_MAS_Communication_Implementation_Plan_2026-05-29.md` 为准。
...
-> Phase P2 same-substrate agent-agent latent communication
```
...
完整 artifact 索引见 `docs/current/CURRENT_EXPERIMENT_STATUS.md`。常用路径：
